...
function initPage(){ 
    hom = document.getElementById("cf_hom");
	hom.onclick = disp_cont_hom;
	
	format = document.getElementById("cf_format");
	format.onclick = disp_cont_format;
	
	contact = document.getElementById("cf_contact");
