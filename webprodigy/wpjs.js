...
function initPage(){ 
    hom = document.getElementById("wp_hom");
	hom.onclick = disp_cont_hom;
	
	format = document.getElementById("wp_format");
	format.onclick = disp_cont_format;
	
	contact = document.getElementById("wp_contact");
